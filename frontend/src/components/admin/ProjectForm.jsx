...
const ProjectForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await adminService.projects.create(data);
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
      <div className="mb-6 pb-4 border-b-2 border-[#E8DCC4]">
        ...
        <h1 className="text-2xl md:text-3xl font-bold bg-linear-to-r from-[#C4A962] to-[#D4AF37] bg-clip-text text-transparent uppercase tracking-tight">Add New Project</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-lg p-6 space-y-6 border-2 border-[#E8DCC4] relative">
        ...
        <div>
          <label className="block text-sm font-medium text-[#4A4A4A] mb-2">
            Project Image * (450 × 350 recommended)
          </label>
          {!imagePreview ? (
            <ImageCropper
